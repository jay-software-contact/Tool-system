 ...
 * (or, at layout time, from ThemeContext.tsx which re-exports these).
 ...
 *     concrete hex values via ThemeContext (see ../../components/ui/ThemeContext.tsx).
...
// Sizing for recurring element types — keeps inline values consistent.
...
// Brand / named primitives. Theme presets in ThemeContext map the semantic
// roles (bg, text, accent…) to these concrete values.
export const colours = {
  // Primary brand palette — amber/teal/orange theme accents
  amber: {
    50: "#fffbeb",
    100: "#fef3c7",
    200: "#fde68a",
...
// Flattened object you can spread into style objects, destructure, or
// iterate. Prefer importing individual groups (fonts, spacing, …) when
